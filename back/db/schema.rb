...
ActiveRecord::Schema[7.2].define(version: 2025_08_09_033517) do
  ...
  create_table "typing_games", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id", "accuracy", "play_time"], name: "index_typing_games_on_post_and_accuracy_and_time", order: { accuracy: :desc }
